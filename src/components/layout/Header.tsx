        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-6">
              <Link href="/brands" className="hover:text-gray-300">브랜드</Link>
              <Link href="/events" className="hover:text-gray-300">이벤트</Link>
            </div>
            <div className="flex items-center gap-6">
              <Link href="/my" className="hover:text-gray-300">마이페이지</Link>
              <Link href="/my/orders" className="hover:text-gray-300">주문조회</Link>
